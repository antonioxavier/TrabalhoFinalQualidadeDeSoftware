...
public abstract class BaseRepositoryService<T extends HasIdentifier> {
     ...
     *
     * @param object The instance to be removed, not {@code null}
     */
    protected void preRemove(@NonNull Object object) {
        // Do nothing
    }
     ...
     * The default behavior is a no-op.
     *
     * @param object The removed instance, not {@code null}
     */
    protected void postRemove(@NonNull Object object) {
        // Do nothing
    }
